        ...
        */
        ...
        this.processChildMessage = function(e) {
            ...
            */
            ...
            // Allow horizontal scroll, but hide scroll bar by making container div slightly smaller than iframe,
            // and setting overflow: hidden
            this.el.setAttribute('style', "height: " + (height-9) + 'px; overflow: hidden')
        }
        ...
        */
        ...
        this.sendHeightToParent = function() {
            ...
            */
            ...
            // Get the child's height, specific tags for TPC tables, to deal with weird height stuff from fixed position elements.
            var height = document.getElementById("headerWrapper").getBoundingClientRect().height + document.getElementById("tableWrapper").getBoundingClientRect().height + document.getElementById("tableNotes").getBoundingClientRect().height + 30;
            // alert(height)
