        ...
        */
        ...
        this.sendHeightToParent = function() {
            ...
            */
            ...
            // var height = document.getElementsByTagName('html')[0].offsetHeight.toString();
            var height = document.getElementById("headerWrapper").getBoundingClientRect().height + document.getElementById("tableWrapper").getBoundingClientRect().height + document.getElementById("tableNotes").getBoundingClientRect().height + 20;
